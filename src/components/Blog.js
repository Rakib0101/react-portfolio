...
const Blog = () => {
  return (
    <section className="section_padding blog pb-0" id="blog">
                        <div className="container">
                            <div className="row">
                                <div className="col-12">
                                    <h2 className="section_heading text-center">Blog</h2>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="blog-item">
                                        <a href="#" className="blog-item__image">
                                            <img src="assets/images/blog/01.png" alt="Blog-Image" className="img-fluid" />
                                        </a>
                                        <div className="blog-item__info">
                                            <a className="title" href="#"> Getting Started With Adobe Xd.</a>
                                            <a className="category" href="#"> Category Design </a>
                                            <div className="blog-item__bottom">
                                                <div className="blog_date">
                                                    <svg id="Dates_Icon" data-name="Dates Icon" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path id="Path_1" data-name="Path 1" className="cls-1"
                                                            d="M12.4,55.5H1.6A1.606,1.606,0,0,1,0,53.9V44.272a1.605,1.605,0,0,1,1.6-1.6H12.4a1.605,1.605,0,0,1,1.6,1.6V53.9A1.606,1.606,0,0,1,12.4,55.5ZM1.6,43.543a.73.73,0,0,0-.729.729V53.9a.73.73,0,0,0,.729.729H12.4a.73.73,0,0,0,.729-.729V44.272a.73.73,0,0,0-.729-.729Zm0,0"
                                                            transform="translate(0 -41.501)" />
                                                        <path id="Path_2" data-name="Path 2" className="cls-1"
                                                            d="M13.563,171.543H.438a.438.438,0,0,1,0-.875H13.563a.438.438,0,0,1,0,.875Zm0,0"
                                                            transform="translate(0 -166.001)" />
                                                        <path id="Path_3" data-name="Path 3" className="cls-1"
                                                            d="M107.105,3.5a.438.438,0,0,1-.437-.437V.438a.438.438,0,0,1,.875,0V3.063A.438.438,0,0,1,107.105,3.5Zm0,0"
                                                            transform="translate(-103.751)" />
                                                        <path id="Path_4" data-name="Path 4" className="cls-1"
                                                            d="M373.77,3.5a.438.438,0,0,1-.437-.437V.438a.438.438,0,0,1,.875,0V3.063A.438.438,0,0,1,373.77,3.5Zm0,0"
                                                            transform="translate(-363.124)" />
                                                    </svg>
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-item mb-0">
                                        <a href="#" className="blog-item__image">
                                            <img src="assets/images/blog/02.png" alt="Blog-Image" className="img-fluid" />
                                        </a>
                                        <div className="blog-item__info">
                                            <a className="title" href="#"> My Work Space Set-up in 2020. </a>
                                            <a className="category" href="#"> Category Design </a>
                                            <div className="blog-item__bottom">
                                                <div className="blog_date">
                                                    <svg id="Dates_Icon" data-name="Dates Icon" xmlns="http://www.w3.org/2000/svg"
